...
# Model list & my stargazer
m_cs_chg = list(m_cs_chg1, m_cs_chg2)
my_stargazer(dest_file = "robust/output/tab_cs_change.tex",
  model_list = m_cs_chg,
  se = lapply(m_cs_chg, function(x) cluster_se(x)),
  omit = "ccaa",
  label = "tab:cs_change",
...
# Model list & my stargazer
m_cs_1118_lim = list(m_cs_1118_full1, m_cs_1118_full2, m_cs_1118_full3)
my_stargazer(dest_file = "robust/output/tab_cs_all_2011.tex",
  model_list = m_cs_1118_lim,
  se = lapply(m_cs_1118_lim, function(x) cluster_se(x)),
  omit = "ccaa",
...
# Model list & my stargazer
m_cs_1118_lim = list(m_cs_1118_lim1, m_cs_1118_lim2, m_cs_1118_lim3)
...
# Model list & my stargazer
m_did_VOX_alt = list(did_VOX_alt1_m, did_VOX_alt2_m, did_VOX_alt3_m, did_VOX_alt4_m)
my_stargazer(dest_file = "robust/output/tab_vox_robustness.tex",
  model_list = m_did_VOX_alt,
  se = lapply(m_did_VOX_alt, function(x) cluster_se(x)),
...
# Model list & my stargazer
m_did_PP_alt = list(did_PP_alt1_m, did_PP_alt2_m, did_PP_alt3_m, did_PP_alt4_m)
my_stargazer(dest_file = "robust/output/tab_pp_robustness.tex",
  model_list = m_did_PP_alt,
  se = lapply(m_did_PP_alt, function(x) cluster_se(x)),
  omit = c("ccaa", "major_2015_izq", "lpop2011", "l_fs_2016_06", "unemp_2016"),
...
# Model list & my stargazer
m_did_PSOE_alt = list(did_PSOE_alt1_m, did_PSOE_alt2_m, did_PSOE_alt3_m, did_PSOE_alt4_m)
my_stargazer(dest_file = "robust/output/tab_psoe_robustness.tex",
  model_list = m_did_PSOE_alt,
  se = lapply(m_did_PSOE_alt, function(x) cluster_se(x)),
  omit = c("ccaa", "major_2015_izq", "lpop2011", "l_fs_2016_06", "unemp_2016"),
...
fsrm1 = glm(fs_rm_2016s2_2018s2_bin ~
  ...
  data = subset(data, fs_2016_06 > 0), family = "binomial")
...
# Model list & my stargazer
m_fsrm = list(fsrm1, fsrm2, fsrm3)
my_stargazer(dest_file = "robust/output/tab_logit_fs_rm.tex",
  model_list = m_fsrm,
  se = lapply(m_fsrm, function(x) cluster_se(x)),
  omit = "ccaa",
