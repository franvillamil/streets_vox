...
\textbf{Response}: {\color{red}{\textbf{PENDING} LAIA}}
...
That said, if we have misunderstood this method and there is indeed a way to apply it to this design, we would be very grateful about some references on how to proceed. We think that this is a very interesting suggestion and that this estimation could potentially improve the analyses.
...
\textbf{Response}: {\color{red}{\textbf{PENDING}}}
...
{\color{red}{\textbf{MORE STUFF PENDING? (Svolik 2020)}}}
