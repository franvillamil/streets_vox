...
\\[-1.8ex]\hline
\hline \\[-1.8ex]
\\[-1.8ex] & \multicolumn{2}{c}{\footnotesize Full sample} & \multicolumn{2}{c}{\footnotesize Restricted sample} \\
...
$n$ & \multicolumn{1}{c}{7,819} & \multicolumn{1}{c}{7,820} & \multicolumn{1}{c}{2,164} & \multicolumn{1}{c}{2,165} \\
R$^{2}$ & \multicolumn{1}{c}{0.442} & \multicolumn{1}{c}{0.500} & \multicolumn{1}{c}{0.292} & \multicolumn{1}{c}{0.318} \\
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.441} & \multicolumn{1}{c}{0.498} & \multicolumn{1}{c}{0.284} & \multicolumn{1}{c}{0.311} \\
\hline
\hline \\[-1.8ex]
\multicolumn{5}{c}{\parbox[t]{0.82\textwidth}{\textit{Note:} $+ p<0.1; * p<0.05; ** p<0.01; *** p<0.001$. The main independent variable refers to the removal of Francoist street names between June 2001 and December 2018. Models 3 and 4 only include municipalities that had Francoist street names in June 2001.}} \\
\end{tabular}
\end{table}
