...
In particular, we include turnout in the April 2019 elections, (logged) population from the 2011 census, the (logged) number of Francoist street names in June 2016, the unemployment rate in January 2016, and a binary indicator of whether a leftist mayor won the May 2015 municipal elections.
...
%we exclude from the sample municipalities where Vox did not participate in June 2016 elections, which leaves us with a total of 1169 municipalities.
...
%This makes the sample a hard test for our hypothesis, as the control group is comprised of municipalities where ``latent Francoism'' is more likely, and thus where Vox could likely grow more between 2016 and 2019.
...
%, and include a test of the parallel trends assumption (section~\ref{app:robustness_did}).
...
%Our results suggest that this policy can cause a backlash. 
