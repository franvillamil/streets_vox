...
\begin{itemize}
  ...
  \item We include a more thorough discussion of Table 1 in appendix, discussing the differences between treated and control municipalities in the sample \textbf{{\color{red}{-- discuss this on appendix}}}
...
{\color{red}{\textbf{-- discutir algo sobre el punto 3 (vox pre-2015) aquí y en el main text/appendix}}}
